        ...
        <div className="border-b border-dashed w-full flex">
          <div className="container mx-auto">
            <div className="flex flex-col items-start border-dashed border-l border-r mx-auto p-6">
              ...
              <p className="text-sm">1. Clique no botão "Escolher arquivo" para selecionar o arquivo de playlist IPTV ou cole a URL da lista IPTV m3u.</p>
        ...
        <div className="border-dashed w-full flex">
          <div className="container mx-auto">
            <div className="flex flex-col border-dashed border-l border-r p-2 py-4 text-sm mx-auto">
              <h1>Built by <a className="underline font-semibold" href="https://github.com/estopassoli">estopassoli</a>. The source code is available on <a className="underline font-semibold" href="https://github.com/estopassoli/iptv-player">GitHub</a>.</h1>
            </div>
          </div>
        </div>
      </ScrollArea>
